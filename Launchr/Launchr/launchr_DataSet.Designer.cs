...
namespace Launchr.launchr_DataSetTableAdapters {
    ...
    public partial class userTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [user] ([id], [name], [address], [phone_number], [email], [country], " +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [user] SET [id] = @id, [name] = @name, [address] = @address, [phone_number] = @phone_number, [email] = @email, [country] = @country, [status] = @status, [is_admin] = @is_admin, [username] = @username, [password] = @password WHERE (([id] = @Original_id))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[4].CommandText = "SELECT id, name, address, phone_number, email, country, status, is_admin, usernam" +
        ...
        public virtual int Fill(launchr_DataSet.userDataTable dataTable) {
        ...
        public virtual int Insert(string id, string name, string address, string phone_number, string email, string country, int status, int is_admin, string username, string password) {
            if ((id == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[7].Value = ((int)(is_admin));
            if ((username == null)) {
                throw new global::System.ArgumentNullException("username");
            }
            else {
        ...
        public virtual int Update(string id, string name, string address, string phone_number, string email, string country, int status, int is_admin, string username, string password, string Original_id) {
            if ((id == null)) {
                throw new global::System.ArgumentNullException("id");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(is_admin));
            if ((username == null)) {
                throw new global::System.ArgumentNullException("username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string address, string phone_number, string email, string country, int status, int is_admin, string username, string password, string Original_id) {
            return this.Update(Original_id, name, address, phone_number, email, country, status, is_admin, username, password, Original_id);
        }
